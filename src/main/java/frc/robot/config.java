...
public static int[] solenoid_vacuum_release = {18, 2}; // PCM0 Channel 2
public static int[] solenoid_hatch_extend = {18, 3}; // PCM0 Channel 3
public static int[] solenoid_gear_shift = {18, 4}; // PCM0 Channel 4
...
public static int[] solenoid_liftbr = {18, 0}; // PCM0 Channel 0
