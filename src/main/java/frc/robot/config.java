...
public static int[] solenoid_hpod = {12,0}; // PCM0 Channel 12
public static int[] solenoid_arm = {13,1}; // PCM1 Channel 13
public static int[] solenoid_vacuum_release = {14, 2}; // PCM2 Channel 14
public static int[] solenoid_hatch_extend = {15, 3}; // PCM3 Channel 15
